...
import { discount, robot, hack } from "../assets";
      ...
      >
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px]  ss:leading-[100.8px] leading-[75px]">
            The Neptune Version Of
            <br className="sm:block hidden" />{" "}
          </h1>
        </div>

        <h1 className="font-poppins font-semibold ss:text-[68px] text-[52px]  ss:leading-[100.8px] leading-[75px] w-full">
          UR Hackathon especially On
          <br className="sm:block hidden" />{" "}
          <span className="text-gradient">Blockchain</span>{" "}
        </h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Hackathon will start on November 11 at 6 p.m. & end on November 13 at
          6 p.m. Winners announcement on November 14 at 7 p.m (Children's Day).
        </p>
      </div>
